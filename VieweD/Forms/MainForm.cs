...
namespace VieweD.Forms
{
    public partial class MainForm : Form
    {
        ...
        internal void UpdateStatusBar(ViewedProjectTab? projectTab)
        {
            if (projectTab != null)
            {
        ...
        internal ViewedProjectTab? OpenFile(string aFileName)
        {
...
#pragma warning restore IDE0079 // Remove unnecessary suppression
        ...
        private void MMFileImportFromCommunity_Click(object sender, EventArgs e)
        {
            ...
            using var importDlg = new ImportFromCommunityDialog();
            if (!importDlg.ImportFromCommunityPost(clipText))
                return;
